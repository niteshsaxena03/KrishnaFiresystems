  ...
  const clients = [
    {
      ...
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=Lumax",
    ...
    },
    {
      ...
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=Lumax+DK",
      logoBackground: "#f8f8f8",
    },
    {
      name: "Lumax Industries Ltd.",
      location: "IP-2, Salempur, Haridwar",
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=Lumax",
      logoBackground: "#f8f8f8",
    },
    {
      name: "Lumax Industries Ltd.",
      location: "Sanand, Gujarat (Ahmadabad)",
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=Lumax",
      logoBackground: "#f8f8f8",
    },
    ...
    },
    {
      ...
      category: "commercial",
      logo: "https://via.placeholder.com/150x80?text=Metropolitan+Mall",
    ...
    },
    {
      ...
      category: "commercial",
      logo: "https://via.placeholder.com/150x80?text=Fortis",
      logoBackground: "#e8f4ff",
    },
    {
      name: "The Ambassador Hotel (Taj Group)",
      location: "New Delhi",
      category: "hospitality",
      logo: "https://via.placeholder.com/150x80?text=Ambassador",
      logoBackground: "#f5f0e8",
    },
    {
      name: "Venu Eye Hospital",
      location: "New Delhi",
      category: "commercial",
      logo: "https://via.placeholder.com/150x80?text=Venu+Eye",
      logoBackground: "#e8fff0",
    },
    {
      name: "Mahindra & Mahindra",
      location: "Mohali, Chandigarh",
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=M&M",
      logoBackground: "#f8f8f8",
    },
    {
      ...
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=C&S",
      logoBackground: "#f8f8f8",
    },
    {
      ...
      location: "Bhagwanpur",
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=Ambuja",
      logoBackground: "#f8f8f8",
    },
    {
      ...
      location: "NOIDA",
      category: "education",
      logo: "https://via.placeholder.com/150x80?text=Step+by+Step",
      logoBackground: "#f0f8ff",
    },
    {
      name: "The Millennium School",
      location: "Noida",
      category: "education",
      logo: "https://via.placeholder.com/150x80?text=Millennium",
      logoBackground: "#f0f8ff",
    },
    {
      ...
      location: "Gurgaon",
      category: "education",
      logo: "https://via.placeholder.com/150x80?text=Rotary",
      logoBackground: "#f0f8ff",
    },
    {
      ...
      location: "Delhi",
      category: "government",
      logo: "https://via.placeholder.com/150x80?text=DMRC",
      logoBackground: "#f0f0f8",
    },
    {
      name: "Delhi Development Authority",
      location: "New Delhi",
      category: "government",
      logo: "https://via.placeholder.com/150x80?text=DDA",
      logoBackground: "#f0f0f8",
    },
    {
      ...
      category: "government",
      logo: "https://via.placeholder.com/150x80?text=PNB",
      logoBackground: "#f0f0f8",
    },
    {
      ...
      location: "New Delhi",
      category: "government",
      logo: "https://via.placeholder.com/150x80?text=PTC",
      logoBackground: "#f0f0f8",
    },
    {
      ...
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=Patanjali",
      logoBackground: "#e8fff0",
    },
    {
      ...
      category: "industrial",
      logo: "https://via.placeholder.com/150x80?text=Toyota",
      logoBackground: "#f8f8f8",
    },
    {
      name: "Make-my-trip",
      ...
      category: "commercial",
      logo: "https://via.placeholder.com/150x80?text=MMT",
      logoBackground: "#f0f0f0",
    },
  ];
